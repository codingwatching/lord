...
local function register_trunk(node_name, softness, tree_height, leaves_radius, register_young, def_override, trunks_group)
	...
	local group = is_young_registration
		...
		or  trunks_group
	trunks.nodes[group] = trunks.nodes[group] or {}
	trunks.nodes[group][node_name] = minetest.registered_nodes[node_name]
...
return {
	...
	get_nodes            = function(trunks_group)
		...
		return trunks.nodes[trunks_group]
	end,
	--- @type string
